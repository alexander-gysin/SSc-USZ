...
# mat_imputed <- log2(mat_imputed + 1)
# -----------------------------------
...
`r what_this_does("Performs sub-setting and data wrangling for the specific contrast.", "Calculates variance to dynamically exclude constant features.", "Executes pareto-scaled Orthogonal Partial Least Squares Discriminant Analysis (OPLS-DA).", "Extracts and visualizes Variable Importance in Projection (VIP) scores to identify primary driving biomarkers.")`
...
```
`r key_insight("There is no PLS-DA detectable difference between the current contrasts.", "Log2 transforming, Man-Whitney U pre filtering, pareto scaling and switching to OPLS-DA have all not made the model better Q2 remains negative")`
